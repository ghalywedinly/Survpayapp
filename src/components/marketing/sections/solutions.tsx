  ...
  return (
    <section id="solutions" className="bg-ink-50/40 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-6">
        <p className="text-base font-semibold uppercase tracking-wide text-brand-content sm:text-lg">{t.solutionsEyebrow}</p>
        <h2 className="mt-3 max-w-2xl text-4xl font-semibold leading-[1.15] tracking-tight text-ink-900 sm:text-5xl">{t.solutionsTitle}</h2>
