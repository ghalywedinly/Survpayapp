...
import { LayersIcon, QrIcon, BarChartIcon, FileTextIcon, BuildingIcon, TicketIcon } from "@/components/icons";
  ...
  return (
    <section id="features" className="bg-ink-50/40 py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <h2 className="mt-3 max-w-2xl text-4xl font-semibold tracking-tight text-ink-900 sm:text-5xl">{t.featuresTitle}</h2>
