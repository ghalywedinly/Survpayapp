    ...
    <section id="how-it-works" className="border-t border-ink-100 bg-surface py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative mt-14 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-5">
          <div className="absolute top-6 hidden h-px w-full bg-ink-100 lg:block" />
          {steps.map((s) => (
            <div key={s.n} className="relative">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-600 text-sm font-semibold text-white dark:bg-white dark:text-[#12151e]">
                {s.n}
              </div>
