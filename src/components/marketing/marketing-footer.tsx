  ...
  return (
    <footer className="bg-surface">
      <div className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid grid-cols-2 gap-10 sm:grid-cols-5">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-ink-600">
              ...
              <li><Link href={`/${locale}#solutions`} className="hover:text-ink-900">{t.footerCx}</Link></li>
              <li><Link href={`/${locale}#solutions`} className="hover:text-ink-900">{t.footerMarket}</Link></li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-ink-600">
              ...
              <li><Link href={`/${locale}#faq`} className="hover:text-ink-900">{t.footerFaq}</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-12 flex flex-col items-start justify-between gap-4 border-t border-ink-100 pt-6 text-xs text-ink-400 sm:flex-row sm:items-center">
